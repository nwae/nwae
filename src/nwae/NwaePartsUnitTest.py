...
if __name__ == '__main__':
    ...
    ut_params = uthelper.UnitTestParams(
        dirpath_wordlist     = config.get_config(param=cf.NwaeConfig.PARAM_NLP_DIR_WORDLIST),
        postfix_wordlist     = config.get_config(param=cf.NwaeConfig.PARAM_NLP_POSTFIX_WORDLIST),
        dirpath_app_wordlist = config.get_config(param=cf.NwaeConfig.PARAM_NLP_DIR_APP_WORDLIST),
        postfix_app_wordlist = config.get_config(param=cf.NwaeConfig.PARAM_NLP_POSTFIX_APP_WORDLIST),
        dirpath_synonymlist  = config.get_config(param=cf.NwaeConfig.PARAM_NLP_DIR_SYNONYMLIST),
        postfix_synonymlist  = config.get_config(param=cf.NwaeConfig.PARAM_NLP_POSTFIX_SYNONYMLIST),
