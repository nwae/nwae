...
class NnDenseModelDesign:
    ...
    def create_network(
        ...
        self.network = self.__create_network_from_config()

    def __create_network_from_config(
            self,
    ):
        try:
            Log.info(
            ...
            self.require_label_to_categorical = \
                self.network_layer_config[NnDenseModelDesign.KEY_MODEL_LABEL_TO_CATEGORICAL]

            network = models.Sequential()

            layers_config = self.network_layer_config[NnDenseModelDesign.KEY_MODEL_LAYERS]
    ...
    def design_network_layers(
        ...
        if self.model_type == NnDenseModelDesign.MODEL_TEXT_EMBEDDING:
        ...
        elif self.model_type == NnDenseModelDesign.MODEL_GENERAL_DATA:
    ...
    def __design_general_data_model(
        ...
        return {
            NnDenseModelDesign.KEY_MODEL_TYPE: self.model_type,
            NnDenseModelDesign.KEY_MODEL_LABEL_TO_CATEGORICAL: True,
            NnDenseModelDesign.KEY_MODEL_LAYERS: [
                {
    ...
    def __design_text_embedding_model(
        ...
        return {
            NnDenseModelDesign.KEY_MODEL_TYPE: self.model_type,
            NnDenseModelDesign.KEY_MODEL_LABEL_TO_CATEGORICAL: False,
            NnDenseModelDesign.KEY_MODEL_LAYERS: [
                {
...
if __name__ == '__main__':
    model_design = NnDenseModelDesign(
    ...
    model_design.get_network().summary()
